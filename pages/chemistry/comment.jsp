...
<%
	try
	{
		...
		Document doc=d.parse("tomcat/webapps/elearn/pages/chemistry/comment.xml");
		...
		StreamResult res=new StreamResult(new File("tomcat/webapps/elearn/pages/chemistry/comment.xml"));
		t.transform(src,res);
		out.print("true");
	}
	catch(Exception e)
